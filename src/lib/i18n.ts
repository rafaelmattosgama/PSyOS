...
const translations = {
  es: {
    ...
    audioTranscriptShow: "Mostrar transcripcion",
    audioTranscriptHide: "Ocultar transcripcion",
    patientYou: "Tú",
    ...
    chatToday: "Hoy",
    chatYesterday: "Ayer",
    eventFlowActive: "Registro en curso",
    eventFlowProgress: "Paso",
    eventCloseButton: "Cerrar registro",
    eventClosing: "Cerrando registro...",
    eventClosed: "Registro cerrado.",
    loading: "Cargando...",
  ...
  pt: {
    ...
    patientSendAudioLabel: "Enviar audio",
    audioTranscriptShow: "Mostrar transcricao",
    audioTranscriptHide: "Ocultar transcricao",
    patientYou: "Você",
    ...
    chatToday: "Hoje",
    chatYesterday: "Ontem",
    eventFlowActive: "Registro em andamento",
    eventFlowProgress: "Passo",
    eventCloseButton: "Encerrar registro",
    eventClosing: "Encerrando registro...",
    eventClosed: "Registro encerrado.",
    loading: "Carregando...",
  ...
  en: {
    ...
    audioTranscriptShow: "Show transcript",
    audioTranscriptHide: "Hide transcript",
    patientYou: "You",
    ...
    eventFlowActive: "Check-in in progress",
    eventFlowProgress: "Step",
    eventCloseButton: "Close check-in",
    eventClosing: "Closing check-in...",
    eventClosed: "Check-in closed.",
    loading: "Loading...",
